...
_stub_module('nav_msgs.msg', Odometry=object, Path=object)
...
_stub_module('geometry_msgs.msg', PoseStamped=object, Point=object)
_stub_module('visualization_msgs')
_stub_module('visualization_msgs.msg', Marker=object, MarkerArray=object)
