...
class CBF:
    ...
    def constraints_cost(self,u_ref,x,y,theta,v):
        ...
        sol = qp_solver(P_torch, q_torch, G_torch, h_torch, torch.zeros(0,dtype=P_torch.dtype, device=P_torch.device), torch.zeros(0,dtype=P_torch.dtype, device=P_torch.device))
