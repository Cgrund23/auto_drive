...
class Controller_Node(Node):
    def __init__(self):
        ...
        self.IP_theta = IP(alpha = 18.0, kp = 15, ki = 0,dt = 0.002)
        self.pressed = 0
        self.pressed2 = 0
    ...
    def lidar_pose_callback(self, msg):
        ...
        left_idx_end = int((msg.angle_max - (3.14 / 2) + 1.57) / msg.angle_increment) - 10  # 180 degrees left
